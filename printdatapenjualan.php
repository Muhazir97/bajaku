...
<br>
  ...
  <h2>Laporan Transaksi Penjualan</h2><hr>
<br>
<br>
...
<body>
  <table class="demo-table"> 
     ...
     <tbody>
         <?php
            ...
            $sql = $koneksi->query("SELECT * from belanja WHERE tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id ASC");
  ...
  <?php } ?>
         ...
         <?php
            ...
            $jumlah = $koneksi->query("SELECT sum(sub_total) as total from belanja WHERE tgl BETWEEN '$tgl_awal' AND '$tgl_akhir'");
