      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
            ...
            <div class="date d-none d-sm-block ">
                ...
                echo $new;
                ?></a>
                  <font style= "font-size:20px;" > &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp;Halo <b><?php echo $_SESSION['username']; ?></b> Anda telah login sebagai <b><?php echo $_SESSION['level']; ?></b> </font>
             </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Barang Terjual Hari Ini</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php
                            ...
                            echo "<th style='text-align:right;'>$total2</th>";}
                          ?>
                      </div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- CARD PENGHASILAN PENJUALAN -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Penghasilan Penjualan Hari ini</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
            ...
            <!-- CARD JUMLAH PEMASANGAN -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Pemasangan Hari ini</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">   
                          <?php
                            include('koneksi.php');
            ...
            <!-- CARD PENGAHSIALN PEMASANGAN -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Penghasilan Pemasangan Hari ini</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">  
                            <?php
            ...
            <div class="card shadow" style="width:1500px;">
              <div class="card-header">
                Grafik Penghasilan Penjualan Bulan Ini
              </div>
              <div class="card-body">
