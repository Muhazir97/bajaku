  ...
  <form action="Tdata_komputer1.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Nama Barang</label>
                 <input type="text" name="nama" placeholder="Nama Barang" class="form-control" required></textarea>
            </div>

            <div class="form-group">
                <label>Kode Barcode</label>
                 <input type="text" name="barcode" placeholder="Kode Barcode" class="form-control" required></textarea>
            </div>

            <div class="form-group">
                <label>Harga Beli</label>
                <input type="text" name="harga_beli" placeholder="Harga Beli" class="form-control" required></textarea>
            </div>

            <div class="form-group">
                <label>Stock</label>
                <input type="text" name="stock" placeholder="Stock" class="form-control" required></textarea>
            </div>
...
<br>
    ...
    <form  action="tables2.php" method="get" >
       <button class="btn btn-primary" type="submit" value="Kembali ke Data Aset"><i class="fas fa-backward"></i> Kembali</button>
    </form>
    <br>
