...
include('koneksi.php');
   ...
   $query_insert ="INSERT INTO nota_pemasangan (tgl,waktu,kasir,nama_customer,no_tlp,alamat,dp1,dp2,dp3,catatan,status) VALUES ('$dmy','$time1','$kasir','$nama_customer','$no_tlp','$alamat','$dp1','$dp2','$dp3','$catatan','$status')" ;
    
   
    $insert= mysqli_query ($koneksi, $query_insert);
    
    $id_nota_pemasangan = $koneksi->insert_id;
...
<table id='tfhover'  class='tftable' border='1' align='center'> <col width='500'><col width='500'>
...
$material         = $select_result['material'] ;
$jumlah   = $select_result['jumlah'] ;

echo "
<tr>
<td style='text-align:center; font-size:20px;'>$material</td>
...
<?php
  ...
  $query_insert ="INSERT INTO data_pemasangan (id_pemasangan,id_brg,material,jumlah,harga_jual,sub_total,kasir,tgl,waktu,id_nota_pemasangan) SELECT id_pemasangan,id_brg,material,jumlah,harga_jual,sub_total,kasir,tgl,waktu,'$id_nota_pemasangan' FROM temp_pemasangan" ;
